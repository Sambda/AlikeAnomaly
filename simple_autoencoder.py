...
def run_simple_autoencoder():
    ...
    if LOAD_WEIGHTS:
      ...
      encoder = load_model("data/weights/CNN_weights_encoder_e30_dim10_ba64_2019-08-01-08:32:50.h5")
      autoencoder = load_model("data/weights/CNN_weights_e30_dim10_ba64_2019-08-01-08:32:50.h5")
    else:
